...
class Language(models.Model):
    """Model representing a Language (Example : English, French, Chinese, etc.)"""
    name = models.CharField(max_length=50, help_text = "Enter the book's natural language (e.g. English, French, Japanese, etc.)")
    def __str__(self):
        return self.name
...
class Book(models.Model):
    ...
    # Author is a string rather than an object because
    ...
    class Meta:
        permissions = (('can_edit_book', 'create or update a book'), 
...
class BookInstance(models.Model):
    ...
    @property
    def is_overdue(self):
        """ Based on current date and due_back, determines if the book is overdue"""
